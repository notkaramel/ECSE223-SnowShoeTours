	...
	public TOSnowShoeTour(int aId, int aStartWeek, int aEndWeek, String aGuideEmail,
		...
		if (!didAddParticipantCosts) {
			throw new RuntimeException(
					"Unable to create TOSnowShoeTour, must not have duplicate participantCosts. See http://manual.umple.org?RE001ViolationofImmutability.html");
		}
	}
