...
public class SnowShoeToursApplication {
  ...
  private static void demoReset() {
    snowShoeTour = new SnowShoeTour(new Date(1), 10, 0);
    ...
    snowShoeTour.addParticipant("jennifer_4@hybrid.ide", "jennifer123", "Jennifer", "(438)333-2222",
        3, 4, 6, true, "", 0);
    snowShoeTour.addParticipant("sameer_6@vscode.love", "", "Sameer", "(438)333-2222", 3, 6, 8,
        true, "", 0);
    ...
    snowShoeTour.addGear("pole", 20);
    snowShoeTour.addGear("shoe", 10);

    snowShoeTour.addCombo("Bestie", 60);
    snowShoeTour.addCombo("Frosty", 70);
